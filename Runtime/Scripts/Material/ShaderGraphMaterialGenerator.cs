    ...
    public class ShaderGraphMaterialGenerator : MaterialGenerator {
            ...
            )
        {
            ...
            if (gltfMaterial.extensions != null)
            {
                ...
                {
                    var clearCoat = gltfMaterial.extensions.KHR_materials_clearcoat.clearcoatFactor;
                    material.SetFloat(ClearCoatMaskProperty, clearCoat);
                    
                    var roughness = gltfMaterial.extensions.KHR_materials_clearcoat.clearcoatRoughnessFactor;
                    material.SetFloat(ClearCoatRoughnessProperty, roughness);
                }
            }
